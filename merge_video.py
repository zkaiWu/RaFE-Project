...
video1 = imageio.get_reader('static\mesh_video\\lego_coarse.mkv')
video2 = imageio.get_reader('static\mesh_video\\lego_fine.mkv')
...
output_file = 'static\mesh_video\\lego_coarse_fine.mp4'
